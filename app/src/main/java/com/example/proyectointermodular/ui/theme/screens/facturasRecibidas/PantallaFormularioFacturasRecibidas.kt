...
@Composable
fun PantallaFormularioFacturasRecibidas(
    navHostController: NavHostController,
    facturaRecibidaViewModel: FacturaRecibidaViewModel = viewModel()
) {
    val facturas by facturaRecibidaViewModel.facturas.collectAsState()
    ...
    facturaEmitidaAEliminar?.let { (id, factura) ->
        AlertDialog(
            ...
            confirmButton = {
                TextButton(
                    onClick = {
                        facturaRecibidaViewModel.eliminarFactura(id)
        ...
        Column(modifier = Modifier.fillMaxSize().padding(top = 16.dp)) {
            Row(
                ...
                FloatingActionButton(
                    onClick = { navHostController.navigate("PantallaAddFacturaRecibida") },
                ...
                LazyColumn(
                    ...
                    items(filteredFacturas) { (id, factura) ->
                        FacturaRecibidaItem(
                            ...
                            onEdit = {
                                navHostController.navigate("PantallaModificarFacturaRecibida/$id")
                            },
                            onDelete = {
